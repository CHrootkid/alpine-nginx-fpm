...
RUN /bin/bash -c "echo extension=memcached >> /etc/php8/conf.d/docker-php-ext-memcached.ini"
RUN /bin/bash -c  "echo extension=igbinary >> /etc/php8/conf.d/docker-php-ext-igbinary.ini"
